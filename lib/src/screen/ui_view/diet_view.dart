                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsets.only(
                                                            left: 4, bottom: 3),
                                                    child: Text(
                                                      ///todo - total cal consume
                                                      '${(notifier.myDiaryData!.totalCal! * animation!.value).toInt()}',
                                                      textAlign:
                                                          TextAlign.center,
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              ///todo - remaining cal left
                                              '${(notifier.myDiaryData!.remainingCal! * animation!.value).toInt()}',
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(
                                                fontFamily:
                                    ...
                                    Padding(
                                      ...
                                      child: CustomPaint(
                                        painter: CurvePainter(
                                            ...
                                            ///todo - remaining cal / recommended cal * 360
                                            angle: (notifier.myDiaryData!
                                                        .remainingCal! /
                                                    (notifier.myDiaryData!
                                                            .totalCal! +
                                                        notifier.myDiaryData!
                                                            .remainingCal!) *
                                                    360) +
